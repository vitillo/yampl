 ...
 * @file   PluginMain.cpp
 * @brief  The file contains the entry point of yampl-pipe plugin
 */
...
/******************** Plugin Info **/
#define PLUGIN_MONIKER "yampl-pipe"
...
hook_exec_status PluginMain(plugin_init_frame* frame)
{
	...
	else
	{
	    // Store the frame for later retrieval
            ...
            reg_params.hk_create  = yampl::pipe::HOOK_CreateObject;
            reg_params.hk_destroy = yampl::pipe::HOOK_DestroyObject;
