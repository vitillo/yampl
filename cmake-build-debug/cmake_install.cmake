...
file(INSTALL DESTINATION "/usr/local/lib/yampl" TYPE SHARED_LIBRARY FILES "/home/ntauthority/Desktop/CERN-HSF/yampl/cmake-build-debug/libyampl.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/yampl/libyampl.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/yampl/libyampl.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/yampl/libyampl.so"
...
file(WRITE "/home/ntauthority/Desktop/CERN-HSF/yampl/cmake-build-debug/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
