...
class RingBuffer{
  public:
    RingBuffer(size_t size, void *buffer, bool isProducer);
...
inline RingBuffer::RingBuffer(size_t size, void *buffer, bool isProducer): m_size(size), m_buffer((char *)buffer), m_head(0), m_tail(0), m_initialized(false){
...
inline size_t RingBuffer::enqueue(void *buffer, size_t size, bool cont){
...
inline size_t RingBuffer::dequeue(void *buffer, size_t size){
...
inline void RingBuffer::enqueueBuffer(void *buffer, size_t size){
...
inline void RingBuffer::dequeueBuffer(void *buffer, size_t size){
